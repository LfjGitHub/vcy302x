...
/*add three command for voice telephone of vcyber, lfj 2019.11.26*/
#define GAIA_COMMAND_USR_ANSWER	(0x02B0)
#define GAIA_COMMAND_USR_REJECT	(0x02B1)
#define GAIA_COMMAND_USR_CANCEL_END	(0x02B2)
