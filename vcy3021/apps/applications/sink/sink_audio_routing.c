...
{
    audio_mic_params_t *mic_params = &config->common_mic_params.mic_1a;

    switch(microphone)
    {
        case microphone_1a:
            mic_params = &config->common_mic_params.mic_1a;
            break;
        case microphone_1b:
            mic_params = &config->common_mic_params.mic_1b;
            break;
        case microphone_2a:
            mic_params = &config->common_mic_params.mic_2a;
            break;
        case microphone_2b:
            mic_params = &config->common_mic_params.mic_2b;
            break;
        case microphone_3a:
            mic_params = &config->common_mic_params.mic_3a;
            break;
        case microphone_3b:
            mic_params = &config->common_mic_params.mic_3b;
            break;
        default:
            break;
    }
...
DESCRIPTION
    Return the configured mic 1a settings
...
DESCRIPTION
    Return the configured mic 1b settings
...
DESCRIPTION
    Return the configured mic 2a settings
...
DESCRIPTION
    Return the configured mic 2b settings
...
/****************************************************************************
NAME
    sinkAudioGetMic3aParams

DESCRIPTION
    Return the configured mic 3a settings

RETURNS
    Mic 3a settings
*/
audio_mic_params sinkAudioGetMic3aParams(void)
{
    sink_audio_readonly_config_def_t *read_data = NULL;
    audio_mic_params mic_params;
    ...
    if (configManagerGetReadOnlyConfig(SINK_AUDIO_READONLY_CONFIG_BLK_ID, (const void **)&read_data))
    {
        sinkAudioReadMicParams(&mic_params, &read_data->common_mic_params.mic_3a);
        configManagerReleaseConfig(SINK_AUDIO_READONLY_CONFIG_BLK_ID);
    }
    return mic_params;
}
...
/****************************************************************************
NAME
    sinkAudioGetMic3bParams

DESCRIPTION
    Return the configured mic 3b settings

RETURNS
    Mic 3b settings
*/
audio_mic_params sinkAudioGetMic3bParams(void)
{
    sink_audio_readonly_config_def_t *read_data = NULL;
    audio_mic_params mic_params;
    ...
    if (configManagerGetReadOnlyConfig(SINK_AUDIO_READONLY_CONFIG_BLK_ID, (const void **)&read_data))
    {
        sinkAudioReadMicParams(&mic_params, &read_data->common_mic_params.mic_3b);
        configManagerReleaseConfig(SINK_AUDIO_READONLY_CONFIG_BLK_ID);
    }
    return mic_params;
}
...
{
    return (bool)(audioGetActiveScoSink());
}
